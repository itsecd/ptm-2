...
1. Создать review в виде простого документа на любой код (не в виде PR, а просто на код в статичной его версии), и переслать преподавателю любым способом - [telegram](https://t.me/MaksimovAleksey)/[discord](https://discordapp.com/users/309018088496693248/).
